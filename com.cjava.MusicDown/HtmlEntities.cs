...
namespace com.winne.MusicDown
{
	internal static class HtmlEntities
	{
		...
		private static Dictionary<string, char> _lookupTable = HtmlEntities.GenerateLookupTable();

		private static Dictionary<string, char> GenerateLookupTable()
		{
			Dictionary<string, char> dictionary = new Dictionary<string, char>(StringComparer.Ordinal);
			string[] entitiesList = HtmlEntities._entitiesList;
		...
		{
			char result;
			HtmlEntities._lookupTable.TryGetValue(entity, out result);
			return result;
		}
	}
}
